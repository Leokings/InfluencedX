    ...
    <section className="marketplace-detail-shell">
      ...
      <div className="campaign-detail-grid">
        ...
        <aside className="campaign-action-panel">
          ...
          {wallet.hasSession || wallet.address || wallet.authenticating ? <button className="wallet-signout" type="button" disabled={wallet.disconnecting} onClick={() => void wallet.signOut().catch(() => undefined)}>{wallet.disconnecting ? "DISCONNECTING…" : "DISCONNECT WALLET"}</button> : null}
        </aside>
      </div>
    </section>
  );
