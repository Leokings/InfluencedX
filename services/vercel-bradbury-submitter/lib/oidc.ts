...
export async function requireCallerOidc(request: Request, config: SubmitterConfig): Promise<void> {
...
function unauthorized(): never {
  throw new SubmitterProblem(401, "CALLER_OIDC_INVALID", "A valid InfluencedX Vercel workload identity is required.");
}
